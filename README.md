...
### Ресурсы Erachain
Основной функционал по цифровым профилям и учету наград, назначений и статусов - уже реализован. Допилка ядра блокчейн - ввести поля у персоны - родители - это 1-2 недели включая добавки АПИ методов и описания.
